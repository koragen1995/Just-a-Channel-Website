                ...
                <main>
                    ...
                    <div class="NewVideos">
                        ...
                        <div class="pagination1">
                            <?php
                            echo '<a href="compilations3.php?comp=' . $checkComp . '">3</a>';
                                ?>
                            <?php
                            echo '<span id="toNextPage"><a href="compilations5.php?comp=' . $checkComp . '">5</a></span>';
                                ?>
                        </div>
                        <?php
                        ...
                        <div class="pagination2">
                            ...
                            echo '<a href="compilations3.php?comp=' . $checkComp . '">3</a>';
                                ?>
                            <?php
                            echo '<span id="toNextPage2"><a href="compilations5.php?comp=' . $checkComp . '">5</a></span>';
                                ?>
                        </div>
                    </div>
                </main>
