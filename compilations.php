            ...
            <section>
                <nav id='navi'>
                    ...
                    <ul>
                        ...
                        <li class="inactive"><a class='row' id='inactiveCompRow'>Compilations</a></li>
                        <ul class="compRows">
                ...
                <main>
                    ...
                    <div class="NewVideos">
                        ...
                        ?>
                            ...
                            <?php
                            echo '<span id="toNextPage"><a href="compilations2.php?comp=' . $checkComp . '">2</a></span>';
                                ?>
                        </div>
                        <?php
                        ...
                        <?php
                            ...
                            $checkin="SELECT * FROM videos WHERE id='".$rl_count."' AND type='compilation'";
                        ...
                        <div class="pagination2">
                            ...
                            <?php
                            echo '<span id="toNextPage2"><a href="compilations2.php?comp=' . $checkComp . '">2</a></span>';
                                ?>
                        </div>
                    </div>
                </main>
