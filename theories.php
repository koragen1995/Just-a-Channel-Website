...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Theories - Just A Channel</title>
            ...
            <section>
                <nav id='navi'>
                    ...
                    <ul>
                        ...
                        <li class="inactive"><a class='row'  id="inactive">Theories</a></li>
                ...
                <main>
                    <div class="NewVideos">
                        ...
                        list ($bg_image_temp, $bg_url_temp, $bg_name_temp, $bg_date_temp) = conntodbtheories($link, $rl_count, $checkComp);
                        ...
                        <?php
                            ...
                            mysqli_query($link, "DROP TABLE theories");
                        ?>
