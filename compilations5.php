                ...
                <main>
                    ...
                    <div class="NewVideos">
                        ...
                        <div class="pagination1">
                            <?php
                            echo '<a href="compilations4.php?comp=' . $checkComp . '">4</a>';
                                ?>
                            <?php
                            echo '<span id="toNextPage"><a href="compilations6.php?comp=' . $checkComp . '">6</a></span>';
                                ?>
                        </div>
                        <?php
                        ...
                        <div class="pagination2">
                            ...
                            echo '<a href="compilations4.php?comp=' . $checkComp . '">4</a>';
                                ?>
                            <?php
                            echo '<span id="toNextPage2"><a href="compilations6.php?comp=' . $checkComp . '">6</a></span>';
                                ?>
                        </div>
                    </div>
                </main>
