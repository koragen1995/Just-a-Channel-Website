                ...
                <main>
                    ...
                    <div class="NewVideos">
                        ...
                        <div class="pagination1">
                            <?php
                            echo '<a href="compilations2.php?comp=' . $checkComp . '">2</a>';
                                ?>
                            <?php
                            echo '<span id="toNextPage"><a href="compilations4.php?comp=' . $checkComp . '">4</a></span>';
                                ?>
                        </div>
                        <?php
                        ...
                        <div class="pagination2">
                            ...
                            echo '<a href="compilations2.php?comp=' . $checkComp . '">2</a>';
                                ?>
                            <?php
                            echo '<span id="toNextPage2"><a href="compilations4.php?comp=' . $checkComp . '">4</a></span>';
                                ?>
                        </div>
                    </div>
                </main>
