            ...
            <section>
                ...
                <main>
                    <div class="NewVideos">
                        ...
                        $rl_count = $rl_count - 1;
                        ?>
                        <div class='product2'><img src="<?=$bg_image_temp[0]?>"></div>
                        ...
                        <div class='product3'><img src="<?=$bg_image_temp[0]?>"></div>
                        ...
                        <div class='product4'><img src="<?=$bg_image_temp[0]?>"></div>
                        ...
                        <div class='product5'><img src="<?=$bg_image_temp[0]?>"></div>
                        ...
                        <div class='product3_date'><a id='product5_date' onclick="window.open('<?=$bg_url_temp[0]?>','mywindow');" style="cursor: pointer;"><?=$bg_date_temp[0]?></a></div>
                        ...
                        <div class='product6'><img src="<?=$bg_image_temp[0]?>"></div>
                        ...
                        <div class='product6_date'><a id='product3_date' onclick="window.open('<?=$bg_url_temp[0]?>','mywindow');" style="cursor: pointer;"><?=$bg_date_temp[0]?></a></div>
                        ...
                        <div class='product7' id='disabled'><img src="<?=$bg_image_temp[0]?>"></div>
                        ...
                        <div class='product8' id='disabled'><img src="<?=$bg_image_temp[0]?>"></div>
