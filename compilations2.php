                ...
                <main>
                    ...
                    <div class="NewVideos">
                        ...
                        <div class="pagination1">
                            <?php
                            echo '<a href="compilations.php?comp=' . $checkComp . '">1</a>';
                                ?>
                            <?php
                            echo '<span id="toNextPage"><a href="compilations3.php?comp=' . $checkComp . '">3</a></span>';
                                ?>
                        </div>
                        <?php
                        ...
                        <div class="pagination2">
                            ...
                            echo '<a href="compilations.php?comp=' . $checkComp . '">1</a>';
                                ?>
                            <?php
                            echo '<span id="toNextPage2"><a href="compilations3.php?comp=' . $checkComp . '">3</a></span>';
                                ?>
                        </div>
                    </div>
                </main>
